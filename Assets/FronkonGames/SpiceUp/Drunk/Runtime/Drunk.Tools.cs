...
namespace FronkonGames.SpiceUp.Drunk
{
  ...
  public sealed partial class Drunk
  {
    ...
    private static readonly Drunk[] NoEffects = new Drunk[0];
    ...
    public static Drunk Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Drunk)
              return scriptableRendererData.rendererFeatures[i] as Drunk;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    private static Drunk[] Instances
    {
      get
      {
