...
#define PI2 6.28318530718
  ...
  // VR-compatible texture sampling for Unity 6
...
#if UNITY_VERSION >= 600000
struct SpiceUpAttributes
{
  uint vertexID : SV_VertexID;
  UNITY_VERTEX_INPUT_INSTANCE_ID
};

struct SpiceUpVaryings
{
...
SpiceUpVaryings SpiceUpVert(SpiceUpAttributes input)
{
  SpiceUpVaryings output;
